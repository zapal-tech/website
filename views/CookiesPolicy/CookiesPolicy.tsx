...
export const CookiesPolicy = () => (
  <AppLayout>
    <div className={styles.CookiesPolicy}>
      ...
      <article id={Section.AGREEMENT_TO_TERMS} className={styles.CookiesPolicy__Article}>
      ...
      <article id={Section.INTELLECTUAL_PROPERTY_RIGHTS} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.USER_REPRESENTATIONS} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.PROHIBITED_ACTIVITIES} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.USER_GENERATED_CONTRIBUTIONS} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.CONTRIBUTION_LICENSE} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.SUBMISSIONS} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          7. SUBMISSIONS
        </Text>
      ...
      <article id={Section.SITE_MANAGEMENT} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          8. SITE MANAGEMENT
        </Text>
      ...
      <article id={Section.TERM_AND_TERMINATION} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.MODIFICATIONS_AND_INTERRUPTIONS} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.GOVERNING_LAW} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          11. GOVERNING LAW
        </Text>
      ...
      <article id={Section.DISPUTE_RESOLUTION} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.CORRECTIONS} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          13. CORRECTIONS
        </Text>
      ...
      <article id={Section.DISCLAIMER} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          14. DISCLAIMER
        </Text>
      ...
      <article id={Section.LIMITATIONS_OF_LIABILITY} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
      ...
      <article id={Section.INDEMNIFICATION} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          16. INDEMNIFICATION
        </Text>
      ...
      <article id={Section.USER_DATA} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          17. USER DATA
        </Text>
      ...
      <article
        ...
        className={styles.CookiesPolicy__Article}
      >
        <Text type="h3" size="heading3">
      ...
      <article id={Section.MISCELLANEOUS} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          19. MISCELLANEOUS
        </Text>
      ...
      <article id={Section.CONTACT_US} className={styles.CookiesPolicy__Article}>
        <Text type="h3" size="heading3">
          20. CONTACT US
        </Text>
