...
export const TermsOfUse = () => (
  <AppLayout>
    ...
    <div className={styles.TermsOfUse__Article}>
    ...
    <article id={Section.AGREEMENT_TO_TERMS} className={styles.TermsOfUse__Article}>
      ...
      <Text size="small">
        ...
        &ldquo;our&rdquo;), concerning your access to and use of the zapal.tech website as well as any other media form,
      ...
      <Text size="small">
        ...
        updating the &ldquo;Last updated&rdquo; date of these Terms of Use, and you waive any right to receive specific
    ...
    <article id={Section.PROHIBITED_ACTIVITIES} className={styles.TermsOfUse__Article}>
      ...
      <Text size="small">
        ...
        formats (&ldquo;gifs&rdquo;), 1×1 pixels, web bugs, cookies, or other similar devices (sometimes referred to as
    ...
    <article id={Section.DISPUTE_RESOLUTION} className={styles.TermsOfUse__Article}>
      ...
      <Text size="small">
        ...
        arbitrators shall be one (1). The seat, or legal place, of arbitration shall be Kyiv, Ukraine. The language of
        the proceedings shall be English and/or Ukrainian. The governing law of the contract shall be the substantive
        law of Ukraine.
      </Text>
    ...
    <article id={Section.LIMITATIONS_OF_LIABILITY} className={styles.TermsOfUse__Article}>
      ...
      <Text size="small">
        ...
        AMOUNT PAID, IF ANY, BY YOU TO US. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON
    ...
    <article id={Section.ELECTRONIC_COMMUNICATIONS_TRANSACTIONS_AND_SIGNATURES} className={styles.TermsOfUse__Article}>
      <Text type="h3" size="heading3">
    ...
    <article id={Section.CONTACT_US} className={styles.TermsOfUse__Article}>
      ...
      <Text size="small">
        ...
        <a href="mailto:policy@zapal.tech" className={styles.TermsOfUse__EmailLink}>
          policy@zapal.tech
        </a>
      </Text>
    </article>
